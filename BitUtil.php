...
class BitUtil {
	 ...
	 */
	public function isBit($value, $position){
		$x = 1 << (int)$position;
		return ($value & $x) != 0;
	}
	 ...
	 */
	public function setBit($value, $position){
		$x = 1 << (int)$position;
		return $value | $x;
	}
	 ...
	 */
	public function unsetBit($value, $position){
		$x = 1 << (int)$position;
		return $value & ~$x;
	}

	public function setBitValue($intValue, $position, $bitValue){
